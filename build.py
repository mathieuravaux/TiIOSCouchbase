...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.mathieuravaux.ti_ios_couchbase.js')
	...
	f = os.path.join(cwd,'Classes','ComMathieuravauxTi_ios_couchbaseModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.mathieuravaux.ti_ios_couchbase.js']
